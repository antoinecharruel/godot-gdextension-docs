...
Material **material_override** = ``[default: 0]``
...
- void **set_material_override** (value: Color)
- Color **get_material_override** ()
...
PackedInt64Array **get_neighbors** (cell_index: int) const :ref:`🔗<class_InteractiveGrid3D_method_get_neighbors>`
