...
project = "Antoine Charruel GDExtensions Documentation"
copyright = (
...
html_context = {
    ...
    "github_user": "antoinecharruel",  # Username
    "github_repo": "godot-gdextension-docs/",  # Repo name
    "github_version": "main",  # Version
    "conf_py_path": "/doc/",  # Path in the checkout to the docs root
    "godot_docs_title": supported_languages[language],
    "godot_docs_basepath": "https://github.com/antoinecharruel/godot-gdextension-docs/tree/main/",
